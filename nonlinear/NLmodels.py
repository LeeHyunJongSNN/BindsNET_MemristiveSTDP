...
from .NLnodes import Input, LIFNodes, DiehlAndCookNodes, AdaptiveLIFNodes
...
class DiehlAndCook2015_NonLinear(Network):
    # language=rst
    """
...
class LocallyConnectedNetwork_Nonlinear(Network):
    # language=rst
    """
